...
export type ExitFunction = ((state: 'reinjected' | 'already_injected' | 'injected' | 'wasnt_injected') => Promise<unknown>) & ((state: 'error', error: Error) => Promise<unknown>) & ((state: 'uninjected') => Promise<unknown>);
